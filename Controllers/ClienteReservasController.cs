...
namespace Caribbean2.Controllers
{
    public class ClienteReservasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdClienteReserva,NombreCliente,Huespedes,TipoDocumento,NumeroDocumento,fechaReserva,fechaLlegada,fechaSalida,IdHabitacion,IdServicio,PrecioTotal")] ClienteReserva clienteReserva)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdClienteReserva,NombreCliente,Huespedes,TipoDocumento,NumeroDocumento,fechaReserva,fechaLlegada,fechaSalida,IdHabitacion,IdServicio,PrecioTotal")] ClienteReserva clienteReserva)
        {
